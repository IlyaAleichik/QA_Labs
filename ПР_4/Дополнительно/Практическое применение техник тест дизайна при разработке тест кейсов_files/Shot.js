...
{		
	...
	//Угол наклона
	expObj["ang"] = 0.2;		
	expObj["flashAlpha"] = 0.4;
	
	fireObj["rotation"] = Math.random()*360;
	fireObj2["rotation"] = fireObj["rotation"]+2;	
	
	TweenLite.to(fireObj, 0.2, {x:10,scaleX:0.8,scaleY:1.0,  ease: Power1.easeOut});	
	TweenLite.to(fireObj, 0.2, {delay:0.1,alpha:0,  ease: Power1.easeOut});

	TweenLite.to(fireObj2, 0.2, {x:10,scaleX:0.6,scaleY:0.8,  ease: Power1.easeOut});	
	TweenLite.to(fireObj2, 0.1, {delay:0.1,alpha:0,  ease: Power1.easeOut});
	
	smokeObj["rotation"] = 5;
	smokeObj2["rotation"] = smokeObj["rotation"]+3.6;
	smokeObj3["rotation"] = smokeObj["rotation"]+1;
	
	TweenLite.to(smokeObj, 0.7, {x:12, alpha:0.6, scaleX:0.9,  scaleY:1.1,  onComplete:smokeHide});	
	TweenLite.to(smokeObj, 1.6, {rotation:smokeObj["rotation"]+1,  ease: Power1.easeOut});	
	
	TweenLite.to(smokeObj3, 0.7, {x:15, alpha:0.6, scaleX:1.4,  scaleY:1.7,  onComplete:smokeHide});	
	TweenLite.to(smokeObj3, 1.6, {rotation:smokeObj3["rotation"]+1.4,  ease: Power1.easeOut});	
	
	TweenLite.to(smokeObj2, 1.75, {x:34, alpha:0.5, scaleX:-1.5,  scaleY:1.9, onComplete:smokeHide2});			
